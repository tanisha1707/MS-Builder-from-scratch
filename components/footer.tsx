        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              MSBUILDER's is a premium real estate company dedicated to finding the perfect property for you. With years
              of experience, we help you make the best investment decisions.
            </p>
